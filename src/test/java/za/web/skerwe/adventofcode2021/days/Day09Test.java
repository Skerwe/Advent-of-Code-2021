...
public class Day09Test {
  ...
  private static final String TEST_INPUT_FILE_NAME = "src/test/resources/test-day09-p1.txt";
  private AdventDay dayTestClass;

  @BeforeEach
  public void initEach() {
    dayTestClass = new Day09();
  }
