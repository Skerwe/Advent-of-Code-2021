...
public class Day08Test {
  ...
  private static final String TEST_INPUT_FILE_NAME = "src/test/resources/test-day08-p1.txt";
  private AdventDay dayTestClass;

  @BeforeEach
  public void initEach() {
    dayTestClass = new Day08();
  }
  ...
  public void testProcessPartTwo() throws IOException {
    ...
    assertNotNull(outputValue);
    assertEquals("61229", outputValue);
  }
